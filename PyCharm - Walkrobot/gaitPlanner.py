...
class trotGait:
    ...
    def loop(self, L, angle, Lrot, T, offset, bodytoFeet_):
        ...
        step_coord, sFR = self.stepTrajectory(self.phi + offset[0], L, angle, Lrot,
                                              np.squeeze(np.asarray(bodytoFeet_[0, :])))  # FR
        ...
        step_coord, sFL = self.stepTrajectory(self.phi + offset[1], L, angle, Lrot,
                                              np.squeeze(np.asarray(bodytoFeet_[1, :])))  # FL
        ...
        step_coord, sBR = self.stepTrajectory(self.phi + offset[2], L, angle, Lrot,
                                              np.squeeze(np.asarray(bodytoFeet_[2, :])))  # BR
        ...
        step_coord, sBL = self.stepTrajectory(self.phi + offset[3], L, angle, Lrot,
                                              np.squeeze(np.asarray(bodytoFeet_[3, :])))  # BL
